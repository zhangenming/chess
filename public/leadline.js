          ...
          i.prototype = {
            ...
            _parseNumber: function () {
              ...
              for (
                ...
                this._currentIndex < this._endIndex && '0' <= this._string[this._currentIndex] && this._string[this._currentIndex] <= '9';
            ...
            b = function (e, t, n, a, i, o, l, r, s, u) {
              ...
              u
                ...
                : ((e = (m = h(e, t, -p)).x),
                  ...
                  (m = o * o),
                  (S =
                    ((f = (r === s ? -1 : 1) * Math.sqrt(Math.abs((f * m - f * d * d - m * y * y) / (f * d * d + m * y * y)))) * i * d) / o +
                    (e + n) / 2),
                  (g = (f * -o * y) / i + (t + a) / 2),
    ...
    'auto-start-reverse' === n
      ? ('boolean' != typeof s &&
        ...
        s
          ...
          : ((r = i.createSVGTransform()).setRotate(180, 0, 0), o.transform.baseVal.appendItem(r), t.setAttribute('orient', 'auto'), (r = !0)))
          ...
          0 < e
            ? 2 === (n = _[(a = p ? 0 : _.length - 1)]).length
              ? ((d[a] = d[a] || Ae.apply(null, n)),
                d[a] > $ &&
                  (d[a] - e < $ && (e = d[a] - $), (s = Ve(n[0], n[1], (p ? e : d[a] - e) / d[a])), (_[a] = p ? [s, n[1]] : [n[0], s]), (d[a] -= e)))
        ...
        (U.plugOutline =
          ...
          [0, 1].forEach(function (e) {
            var t = u.plugOutline_plugSE[e],
              n = t !== Y ? X[q[t]] : null
            ;(y =
              Xe(r, u.plugOutline_enabledSE, e, s.plugOutlineEnabledSE[e] && u.plug_enabled && u.plug_enabledSE[e] && !!n && !!n.outlineBase) || y),
      ...
      dropShadow: {
        ...
        adjustEdge: function (a, i) {
          ...
          null != o.dropShadow_dx &&
            ...
            (e = { x1: i.x1 - e + o.dropShadow_dx, y1: i.y1 - e + o.dropShadow_dy, x2: i.x2 + e + o.dropShadow_dx, y2: i.y2 + e + o.dropShadow_dy })
              .x1 < i.x1 && (i.x1 = e.x1),
            e.y1 < i.y1 && (i.y1 = e.y1),
            e.x2 > i.x2 && (i.x2 = e.x2),
            e.y2 > i.y2 && (i.y2 = e.y2),
                ...
                'onmouseenter' in n && 'onmouseleave' in n
                  ...
                  : (console.warn('mouseenter and mouseleave events polyfill is enabled.'),
                    n.addEventListener(
                      ...
                      (o = function (e) {
                        ;(e.relatedTarget &&
                          (e.relatedTarget === this || this.compareDocumentPosition(e.relatedTarget) & Node.DOCUMENT_POSITION_CONTAINED_BY)) ||
      ...
      captionLabel: {
        ...
        initSvg: function (t, n) {
          ...
          ;['elmPosition', 'styleFill', 'styleShow', 'elmsAppend'].forEach(function (e) {
            ...
            (t.height = e.height),
            t.outlineColor &&
              ((a = e.height / 9), (i.styleStroke.strokeWidth = (a = 10 < a ? 10 : a < 2 ? 2 : a) + 'px'), (i.styleStroke.stroke = t.outlineColor)),
            (t.strokeWidth = a || 0),
      ...
      pathLabel: {
        ...
        initSvg: function (t, n) {
          ...
          ;['elmPosition', 'elmPath', 'elmOffset', 'styleFill', 'styleShow', 'elmsAppend'].forEach(function (e) {
            ...
            (t.height = e.height),
            t.outlineColor &&
              ((a = e.height / 9), (o.styleStroke.strokeWidth = (a = 10 < a ? 10 : a < 2 ? 2 : a) + 'px'), (o.styleStroke.stroke = t.outlineColor)),
            (t.strokeWidth = a || 0),
